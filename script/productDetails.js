...
// var productData1 = JSON.parse(localStorage.getItem("productNextPageData"));
// console.log(productData1)
var productData = JSON.parse(localStorage.getItem("individualShowData"));
// console.log(productData)

// console.log(productData);

nextProductDetails(productData);
...
function nextSlide() {
  console.log(productData.imagesAll[count])
  ...
  document
    .getElementById("next_product_image")
    .setAttribute("src", productData.imagesAll[count]);
  count++;
...
function backSlide(){
  ...
  document
    .getElementById("next_product_image")
    .setAttribute("src", product.imagesAll[count]);
  count--;
...
let popular_products=JSON.parse(localStorage.getItem("popular_products"));
